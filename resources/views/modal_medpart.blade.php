              ...
              <div class="col-12 d-flex justify-content-center row">
                <div class="col-5 d-flex justify-content-center">
                  <div class="comment-box d-flex justify-content-center align-items-center">
                    <script class="video_id" id="" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js" style="width: 80%;height: 80%;"><div class="script_id"> </div></script>
                  </div>
                </div>
                ...
                <div class="col-7 d-flex justify-content-center row">
                  ...
                  <div class="col-12 d-flex justify-content-center align-items-center row">
                    <a class="col-6 col-lg-6 medpart d-flex justify-content-center align-items-center" id="ig_section"><i class="fab fa-instagram"></i></a>
                    <a class="col-6 col-lg-6 medpart d-flex justify-content-center align-items-center" id="fb_section"><i class="fab fa-facebook"></i></a>
