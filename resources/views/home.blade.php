...
<body>
    ...
    <section id="intro" class="intro-page d-flex">
      <div class="container-fluid d-flex align-items-center">
          <div class="row"> <!-- h-100 -->
            ...
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
              <a class="btn-signin" data-bs-toggle="modal" data-bs-target="#loginModal"><h4 style="font-size: 30px;">LOG IN</h4></a>
            </div>
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
              <h6 style="color: #1C3B51;">OR</h6>
            </div>
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
              <a class="btn-signup" data-bs-toggle="modal" data-bs-target="#registrationModal"><h4 style="font-size: 30px;">SIGN UP</h4></a>
            </div>
            <!--
            <div class="col-lg-12 d-flex align-items-center justify-content-center ">
      ...
      <a href="#about" class="menu d-flex align-items-center justify-content-center"><i class="fas fa-bars"></i></a>
    ...
    <div class="modal fade" id="loginModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog"> <!--  modal-fullscreen-md-down -->
        <div class="modal-content modal-signin-signup">
          ...
          <div class="modal-body col-12 row">
            ...
            <div class="col-1 d-flex justify-content-stretch">
              <a class="icon-close" data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times-circle"></i></a>
            </div>
            <div class="col-11 d-flex justify-content-center align-items-center mt-4">
        ...
        <div class="modal-content modal-signin-signup">
          ...
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="modal-body col-12 row">
              ...
              <!-- Email -->
              <div class="col-11 d-flex align-items-center row">
                <x-jet-validation-errors class="col-12 mb-4" />
                <div class="col-4 d-flex justify-content-end">
                  <x-jet-label for="email" value="{{ __('Email') }}" />
                </div>
                <div class="col-8 d-flex mx-2">
                  <x-jet-input id="email" class="col-8" type="email" name="email" :value="old('email')" required autofocus />
                </div>
              </div>
