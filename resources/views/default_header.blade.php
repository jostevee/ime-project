...
<!-- Favicons -->
<link href="{{ asset('assets/img/intro_page/ime_logo_transparent_new.png') }}" rel="icon">
<link href="{{ asset('assets/img/intro_page/ime_logo_transparent_new.png') }}" rel="apple-touch-icon">
