...
<a href="#" class="sound d-flex align-items-center justify-content-center"><i class="fas fa-volume-up"></i></a>
<a href="#" class="ig-btn d-flex align-items-center justify-content-center"><i class="fab fa-instagram"></i></a>
