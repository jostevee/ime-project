...
<head>
  ...
  <title>Indonesia Marine Exhibition - Talkshow Room - DAY 1</title>
        ...
        <div class="container mt-4">
          ...
          <div class="row d-flex justify-content-center mt-4">
            <div class="col-12 mt-4">
              <h1 class="text-center yellow-title">DAY 1</h1>
            </div>

            <div class="col-12 mt-1">
              <h3 class="text-center yellow-title">POTRAIT OF OUR WONDERFUL INDONESIA MARITIME</h3>
            </div>
            ...
            <div class="row col-12 justify-content-center mt-4">
              <div class="row talkshow-details-people-box justify-content-center align-items-center col-lg-3 mb-2">
                ...
                <h4 class="text-center blue-title">DAY 1</h4>
                <!-- <h4 class="text-center blue-regulsar"></h4> -->
                <!-- <a class="youtube d-flex align-items-center justify-content-center"></a> -->
                <a href="https://ipb-university.zoom.us/j/99148766469?pwd=NjNnaVNEOVl1ZUVDU1VORlNub1N4dz09" class="zoom d-flex align-items-center justify-content-center"></a>
              </div>
            </div>
          </div>
