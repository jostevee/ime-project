...
<head>
  ...
  <title>Indonesia Marine Exhibition - Admin Page - Edit Payment User</title>
...
<body>
  ...
  <main id="main">
    ...
    <section id="payment-user" class="services general-form bg-light py-4">
      <div class="container">
      <!-- container-fluid -->

          <div class="section-title">
            <h2>Edit Payment User</h2>
          </div>
                ...
                <div class="row">
                  ...
                  @endif
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="{{ $payment_user->name }}" disabled>
                    </div>
                    <div class="form-group mt-4">
                      <label for="title">Email</label>
                      <input type="text" class="form-control" value="{{ $payment_user->email }}" disabled>
                    </div>
                    <div class="form-group mt-4">
                      <label for="title">Google ID</label>
                      <input type="text" class="form-control" value="{{ $payment_user->google_id }}" disabled>
                    </div>
                    <div class="form-group mt-4">
                      <label for="title">Paid Status</label>
