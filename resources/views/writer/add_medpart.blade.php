...
<head>
  ...
  <title>Indonesia Marine Exhibition - Admin Page - Add Medpart</title>
            ...
            <div class="row">
              ...
              @endif
                ...
                <div class="form-group col-4 mt-4">
                  ...
                  <input type="text" name="ig" id="ig" class="form-control" placeholder="Enter Medpart Instagram page here">
                </div>
                <div class="form-group col-4 mt-4">
                  <label for="title">FB</label>
                  <input type="text" name="fb" id="fb" class="form-control" placeholder="Enter Medpart Facebook page here">
                </div>
                <div class="form-group mt-4">
