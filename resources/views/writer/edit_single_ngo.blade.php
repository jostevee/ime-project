...
<head>
  ...
  <title>Indonesia Marine Exhibition - Admin Page - Edit NGO</title>
                ...
                <div class="row">
                  ...
                  @endif
                    ...
                    <div class="form-group col-4 mt-4">
                      ...
                      <input type="text" name="ig" id="ig" class="form-control" value="{{ $ngo->ig }}">
                    </div>
                    <div class="form-group col-4 mt-4">
                      <label for="title">FB</label>
                      <input type="text" name="fb" id="fb" class="form-control" value="{{ $ngo->fb }}">
                    </div>
